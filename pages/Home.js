  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="flex flex-wrap my-5 justify-between items-center mx-9">
        ...
        <form onSubmit={changeSearch} className="form-control">
          <input
            type="text"
            placeholder="Search"
      ...
      <footer className="footer items-center p-4 bg-transparent text-neutral-content mt-16">
        <div className="items-center grid-flow-col">
          <svg
            ...
            fill-rule="evenodd"
            clip-rule="evenodd"
            className="fill-current hover:fill-primary cursor-pointer transition-all duration-300"
          >
          ...
          <p>Copyright © 2022 - All right reserved to Devjay</p>
        </div>
